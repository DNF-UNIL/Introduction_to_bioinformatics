...
author: "Adrian C Lo and Ludovic T"
date: "12/4/2019"
...
[First DNF coding club session ressource link](https://dnf-unil.github.io/dnfcodingclub/06_11_19_session.html)

R is a console, you can type all the calculation you want and see the result
...
You can call a function ex : do the sum
...
[Also check](https://www.datamentor.io/r-programming/if-else-statement/)
...
[Also check](https://www.guru99.com/r-for-loop.html)
